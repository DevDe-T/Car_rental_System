...
class rent : public customer // inhereted class from customer class
{
    ...
    do
    {
        ...
        cout<<"\t\t\t\tEnter 'A' for Tesla x"<<endl;
        cout<<"\t\t\t\tEnter 'B' for Range Rover"<<endl;
        cout<<"\t\t\t\tEnter 'C' for Fortuner"<<endl;
        cout<<endl;
 ...
 if(carmodel=="A")
 {
 	system("CLS");
		...
		cout<<"You have choosed Tesla x"<<endl;
...
sleep(2);
 ...
 {
 	system("CLS");
	     cout<<"You have choosed Fortuner"<<endl;
...
obj1.welcome(); //welcum function is called
rent obj2; 
